...
export const APPLICATION_COLUMNS =
    "grid min-w-[76rem] grid-cols-[1.75rem_minmax(9rem,1.6fr)_minmax(9rem,1.7fr)_8.5rem_minmax(7rem,1.2fr)_6.5rem_9.5rem_8rem_5rem_4.5rem] items-center gap-x-3";
